...
CLASSES = {
    ...
    'myrmidon': {'name': '剑士',   'hp': 18, 'pow': 7,  'skl': 11, 'spd': 11, 'dfn': 4,  'mov': 5,
                 'weapon': 'sword',
    ...
    'e_archer': {'name': '弓兵',   'hp': 18, 'pow': 6,  'skl': 7,  'spd': 6,  'dfn': 3,  'mov': 5,
                 'weapon': 'bow', 'growth': {}},
    'e_myrm':   {'name': '剑士',   'hp': 18, 'pow': 6,  'skl': 9,  'spd': 9,  'dfn': 3,  'mov': 5,
                 'weapon': 'sword', 'growth': {}},
    'warrior':  {'name': '勇士',   'hp': 30, 'pow': 10, 'skl': 8,  'spd': 7,  'dfn': 9,  'mov': 5,
                 'weapon': 'axe', 'growth': {}},
    'shaman':   {'name': '妖术师', 'hp': 24, 'pow': 9,  'skl': 7,  'spd': 6,  'dfn': 6,  'mov': 5,
                 'weapon': 'magic', 'growth': {}},
    'general':  {'name': '重甲将军', 'hp': 34, 'pow': 11, 'skl': 7, 'spd': 4,  'dfn': 13, 'mov': 4,
                 'weapon': 'lance', 'growth': {}},
}
